...
export default function Podcasts() {
    ...
    return (
        ...
        <div className="flex flex-col items-center my-8">
            {arr.map((video) => <Card className="m-3 p-5 relative group " key={video.path}>
                ...
                <div className="md:group-hover:flex hidden text-lg absolute left-[25px] top-[10%]">
                    <p className="ml-4 scroll-m-20 text-md md:text-2xl font-semibold tracking-tight">{video.title}</p>
                ...
                <div className="md:hidden flex text-md mt-4">
                    <p className="ml-4 scroll-m-20 text-md font-semibold tracking-tight ">{video.title}</p>
